# Copywrite — Facebook — W20 (12-18/5/2026)
**Agent:** Content Execution  
**Brand:** SPK HAPPY  
**Platform:** Facebook Fanpage + Facebook Reels  
**Tone:** Warm, conversational, family-oriented (khác TikTok tone)

---

## ⚠️ Facebook Copywrite Principles (vs TikTok)

| Aspect | TikTok | Facebook |
|---|---|---|
| **Tone** | Quick, punchy, entertaining | Warm, reassuring, motherly |
| **Hook** | Curiosity gap (3s) | Direct value/emotion (2 lines) |
| **Length** | Short (1-2 sentences on screen) | Medium (3-5 sentences) |
| **CTA** | "Comment your questions" | "Save + share with [husband/friends]" |
| **Target emotion** | Surprise/entertainment | Safety/belonging |
| **Hashtags** | Trending (viral) | Branded + community-focused |

**Key:** Facebook = family decision, TikTok = personal discovery

---

## 📝 Bài #1 — Luật Dân Số 7 Tháng (Repost FB Reels)

**Context:** Same video as TikTok, but caption 100% different for Facebook audience (couples, families, older relatives)
...
## 📝 Bài #2 — 9 Mốc Khám Thai (FB Post - Infographic)

**Context:** Static image (infographic). Facebook audiences like to save infographics. Caption must be short (first 2-3 lines will be cut by "Xem thêm").
...
## 📝 Bài #4 — Thai Tuần 8 (Repost FB Reels)

**Context:** Repost of TikTok bài #3, but tone is warmer and focused on reassurance (not entertainment)
...
📌 Đang lo về tuần thai của mình? Để lại câu hỏi bên dưới. BS Thư trả lời.
...
## 📋 Copywrite Strategy — Facebook vs TikTok

### Timeline (Same Content, Different Copy)

| Bài | Channel | Post Time | Hook Style | CTA | Length |
|---|---|---|---|---|---|
| #1 Luật | **TikTok** | 19:00 | Curiosity (3s) | Comment question | 1 sentence on screen |
| #1 Luật | **FB Reels** | 19:30 | Emotion (family) | Save + share | 3-5 sentences |
| #2 Infographic | **FB Post** | 08:00 | Value (checklist) | Save + tag | 2-3 paragraphs |
| #3 Thai W8 | **TikTok** | 12:00 | Entertainment | Comment | 1 sentence on screen |
| #4 Thai W8 | **FB Reels** | 12:30 | Reassurance | Comment | 3-4 sentences |

### Facebook Copywrite Guidelines (for execution team)
...
- ✅ "Comment your concerns" (but warmer than TikTok)
- ✅ "Tag someone who needs this"
- ❌ Don't use "Follow for more" (awkward on Fanpage)
- ❌ Don't use "Link in bio" (no bio link)

**Tone Rules:**
- Warm, conversational, like talking to a friend
- Reassurance > entertainment (opposite of TikTok)
- Educational > trendy
- Family-oriented (husbands, mothers-in-law read too)
- Expertise shown but not boasted ("BS Thư will explain" not "I'm the best doctor")

**Hashtag Rules:**
- 3-5 branded/community hashtags (not trending)
- Examples: #mebau #thaiky #khámthai #pkspkhappy
- Order: put branded hashtag (#pkspkhappy) last
...
*Note: Nếu muốn A/B test, publish V1 trước (recommended), rồi W21 test V2/V3 trên same topic nếu cần*
